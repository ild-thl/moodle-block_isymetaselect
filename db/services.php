<?php
$functions = array(
    'blocks_isymetaselect_getfilter' => array(           //web service name (unique in all Moodle)
        'classname'   => 'blocks_isymetaselect_external', //class containing the function implementation
        'methodname'  => 'get_filter',              //name of the function into the class
        'classpath' => 'blocks/isymetaselect/externallib.php',
...
$services = array(
    'get_filter' => array(
            'functions' => array ('blocks_isymetaselect_getfilter'), 
