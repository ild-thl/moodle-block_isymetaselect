<?php
$functions = array(
    'blocks_metatiles_getfilter' => array(           //web service name (unique in all Moodle)
        'classname'   => 'blocks_metatiles_external', //class containing the function implementation
        'methodname'  => 'get_filter',              //name of the function into the class
        'classpath' => 'blocks/metatiles/externallib.php',
...
$services = array(
    'get_filter' => array(
            'functions' => array ('blocks_metatiles_getfilter'), 
