...
$string['university'] = 'Programm'; // vorher: Universität
$string['university_all'] = 'Alle Programme';

$string['subjectarea'] = 'Format'; // vorher: Wissensgebiet
$string['subjectarea_all'] = 'Alle Formate';

$string['german'] = 'Deutsch';
$string['english'] = 'Englisch';

$string['lecturer_detail'] = 'Dozent*in'; // vorher: Anbieter*innen
